...
public class TestHtmlTables extends TestCase {
    ...
    public void testSortedTables() {
        ...
        new Row<Key.RevFloat>(table, new Key.RevFloat(10000.55)).add("Clark Kent").addKey().add(0);
        new Row<Key.RevFloat>(table, new Key.RevFloat(5672.41)).add("Barry Allen").addKey().add(0);
        new Row<Key.RevFloat>(table, new Key.RevFloat(671203.33)).add("Bruce Wayne").addKey().add(6);
        new Row<Key.RevFloat>(table, new Key.RevFloat(9000.00)).add("Lois Lane").addKey().add(1);
        ...
        new Row<Key.Mixed>(table2, new Key.Mixed("fig|83333.peg.3")).addKey().add("Aludium phosphate").add(612);
        new Row<Key.Mixed>(table2, new Key.Mixed("fig|10462.peg.2")).addKey().add("Arginine thingsethis").add(546);
        new Row<Key.Mixed>(table2, new Key.Mixed("fig|10462.peg.10")).addKey().add("Adeline oh Adeline").add(462);
        new Row<Key.Mixed>(table2, new Key.Mixed("fig|10462.peg.1")).addKey().add("Threonine stuffase").add(312).add(0.9642);
        new Row<Key.Mixed>(table2, new Key.Mixed("fig|83333.peg.12")).addKey().add("Threonine stuffase").add(512).add(0.246);
        ...
        new Row<Key.Text>(table3, new Key.Text("A new subsystem")).addKey().add(0);
        new Row<Key.Text>(table3, new Key.Text("An old subsystem")).addKey().add(0);
        new Row<Key.Text>(table3, new Key.Text("Arginine thingnitase")).addKey().add(1);
        new Row<Key.Text>(table3, new Key.Text("Adenine synthase")).addKey().add(1);
        new Row<Key.Text>(table3, new Key.Text("Alludium deForest")).addKey().add(0);
        new Row<Key.Text>(table3, new Key.Text("Alludium deforest")).addKey().add(0);
        new Row<Key.Text>(table3, new Key.Text("Frosty the snowman")).addKey().add(1);
        new Row<Key.Text>(table3, new Key.Text("Effluent ruthlessness")).addKey().add(0);
        ...
        new Row<Key.Null>(table4, Key.NONE).add("Adenine synthase").add(0).add(true);
        new Row<Key.Null>(table4, Key.NONE).add("Alludium deForest").add(3).add(false);
        new Row<Key.Null>(table4, Key.NONE).add("Alludium deforest").add(2).add(false);
        new Row<Key.Null>(table4, Key.NONE).add("Frosty the snowman").add(1).add(false);
        new Row<Key.Null>(table4, Key.NONE).add("Effluent ruthlessness").add(0).add(true);
