 ...
 */
public class IFramePageWriter extends PageWriter {

    /** style sheet link */
    public static final EmptyTag FRAME_STYLES = link().withRel("stylesheet").withHref("/SEEDtk/css/Frame.css");
    ...
    public String local_url(String url) {
        return SeedTkPageWriter.fixUrl(url);
    }
